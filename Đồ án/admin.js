...
var productAdmin = function () {
    ...
    for (var i in product) {
        ...
        listproduct1 +=
            ...
            ')" class="btn btn-outline-danger" date-toggle="modal" data-targer="#updateProduct"><i class="fas fa-cogs></i></button>" ';
        listproduct1 +=
            '<td><button onclick="deleteProduct"(' + i + ')"class=" btn ml-1 btn-outline-warning"><i class="fas fa-trash></i></button></td>';
        listproduct1 += '</tr>';
